...
4. **このSTEP（STEP${stepNum}「${stepName}」）の修正アクションリスト** ← 最重要
   ...
   **このSTEPの出力に対する修正アクションのみ**を書いてください。
   ...
   ─────────
   【優先度: 高/中/低】観点: 読者像の一貫性 / コンセプトの一貫性 / 商業誘導性 / 差別化 / 橋渡し設計 / その他
...
率直に。建前抜きで。ただし建設的に。
**「このSTEPの修正アクションリスト」と「コピペ用改善指示文」を必ず含めること**。
        ...
        <div style={{ padding: 14 }}>
          ...
          {mode === "review" && (
            <div style={{ fontSize: 12.5, color: C.textSub, lineHeight: 1.7, marginBottom: 10, padding: "8px 12px", background: "#fff7e6", border: "1px solid #ffd591", borderRadius: 4 }}>
              ...
              <strong>このSTEP（STEP{stepNum}）に絞って</strong>、読者像／コンセプト／商業誘導性／差別化／橋渡し設計／致命的欠陥 を評価し、
              <strong>「このSTEPの修正アクション + コピペ用改善指示文」</strong>を返してくれます。
              <br />
              <strong style={{ color: C.gold }}>使い方</strong>：レビュー結果の「★ コピペ用改善指示文」を、このSTEPの「💡改善案」モードのプロンプトに追加して外部AIに貼ると、その指示で改訂版が生成されます。
              <br />

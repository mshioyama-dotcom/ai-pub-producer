...
const SideMenu = ({ currentPage, onNavigate, stepStatuses }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ fontSize: 13, fontWeight: 800, color: "#1a1a2e", letterSpacing: "0.02em", padding: "0 14px", marginBottom: 6, marginTop: 4 }}>
        ホーム
      </div>
        ...
        {showResetConfirm && (
          <div style={{ marginTop: 12, padding: 16, background: "#fff4f4", border: "1px solid #fca5a5", borderRadius: 8 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <BtnPrimary
                onClick={async () => { await resetAllData(); location.reload(); }}
    ...
    <div>
      ...
      <div style={{ marginBottom: 28 }}>
        ...
        {validationErrors.length > 0 && (
          <div style={{ padding: "10px 14px", background: "#fef2f2", border: "1px solid #fca5a5", borderRadius: 6, marginBottom: 12, fontSize: 13, color: "#dc2626", fontWeight: 500 }}>
        ...
        {step.inputs.map((field) => {
          ...
          const handleAutoFillParsed = isStep3ParsedField
            ? () => {
                ...
                if (!srcOutput) {
                  alert("STEP2の出力データがまだ保存されていません。\nSTEP2で「出力データを保存」を押してから再度お試しください。");
                  return;
                }
      ...
      {step.help && step.help.length > 0 && (
        <div style={{ marginBottom: 16 }}>
          <div
            ...
            style={{ fontSize: 13.5, fontWeight: 600, color: "#555", cursor: "pointer", display: "flex", alignItems: "center", gap: 6, padding: "10px 0" }}
          >
    ...
    <div>
      ...
      <Section title="操作方法（ワークフロー型：STEP2・3・5〜10）">
        <ul style={{ margin: 0, paddingLeft: 18 }}>
          ...
          <li style={{ marginTop: 4 }}>
            <span style={{ fontWeight: 700 }}>自動振り分け（紫）</span>：STEP3専用。押すとSTEP2の出力から該当箇所を自動で抽出して入力する
          </li>
      ...
      {refPanel && (
        <div style={{
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
            ...
            <button onClick={() => setRefPanel(null)} style={{ background: "none", border: "none", fontSize: 20, cursor: "pointer", color: "#888", lineHeight: 1, padding: "0 4px" }}>✕</button>
          </div>
